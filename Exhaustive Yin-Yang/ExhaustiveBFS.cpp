...
bool check_2by2(vector<vector<char>> pb)
{
    ...
    for (size_t i = 0; i < m-1; i++)
    {
        for (size_t j = 0; j < n-1; j++)
        {
            ...
            ss >> s;
            if ((s.compare("0000") == 0) || (s.compare("1111") == 0) || (s.compare("0110") == 0) || (s.compare("1001") == 0))
            {
                return false;
            }
        }
...
bool verify_no_pruning(vector<vector<char>> pb)
{
    if (check_2by2(pb) == true)
    {
        int b_count = 0;
        int w_count = 0;
        for(auto& v: pb)
...
int main()
{
    ...
    for (size_t i = 0; i < 3; i++)
    {
        ...
        if (check_2by2(playboard) == true)
        {
            ...
            {
                bool valid = verify_no_pruning(config);
                if (valid)
                {
                    total++;
